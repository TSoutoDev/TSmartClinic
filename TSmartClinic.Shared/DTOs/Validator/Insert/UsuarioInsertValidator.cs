...
{
    public class UsuarioInsertValidator : AbstractValidator<UsuarioInsertRequestDTO>
    {
        public UsuarioInsertValidator()
        {
            ...
            RuleFor(x => x.LoginInclusao)
                .NotEmpty().When(x => !string.IsNullOrEmpty(x.LoginInclusao))
            ...
            // PrimeiroAcesso: booleano, default true, não precisa de validação obrigatória
